    ...
    <div>
      ...
      >
        ...
        >
          ...
          <TextField helperText="Enter Services" id="demo-helper-text-aligned" label="Service" value={serviceName}
            onChange={(e) => { setServiceName(e.target.value); setError("") }}
          />
          {error?.ServiceName && <div className='error-msg'>{error.ServiceName}</div>}
          <TextField helperText=" Note" id="demo-helper-text-aligned-no-helper" label="Note" value={note}
